...
static void CheckAssetPaths() {
    ...
    for(size_t i=0;i<NUM_DEFAULT_DFS_DISCS;++i) {
        CheckAssetPath(DEFAULT_DFS_DISCS[i].GetAssetPath());
    }

    for(size_t i=0;i<NUM_DEFAULT_ADFS_DISCS;++i) {
        CheckAssetPath(DEFAULT_ADFS_DISCS[i].GetAssetPath());
    }
}
